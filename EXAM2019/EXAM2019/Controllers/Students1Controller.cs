...
namespace EXAM2019.Controllers
{
    public class Students1Controller : Controller
    {
        ...
        public Students1Controller(EXAM2019Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StudentID,FirstName,LastName,PhoneNumber,Email")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("StudentID,FirstName,LastName,PhoneNumber,Email")] Student student)
        {
